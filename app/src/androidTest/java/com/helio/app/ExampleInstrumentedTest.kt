...
class ExampleInstrumentedTest {
    ...
    @Test
    fun controlSliderWorks() {
        // https://stackoverflow.com/a/65400816/
        onView(withId(R.id.controlSlider)).check(matches(withValue(1.0F)))

        onView(withId(R.id.controlSlider)).perform(setValue(2.0F))

        onView(withId(R.id.controlSlider)).check(matches(withValue(2.0F)))
    }
